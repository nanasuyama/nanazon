...
<table class="table table-striped" style="margin-top: 200px;">
    ...
    <tbody>
        ...
        ?>
                            <a href='category_action.php?action=delete&user_id=<?php echo $id;?>' class='btn btn-danger btn-sm' onclick='return confirm("Are you sure you want to delete?");'>Delete</a>
                            </td>
                        </tr>
        <?php
                }
