...
?>
	...
	<div class="main_slider" style="background-image:url(../images/topimage.jpg)">
						...
						<div class="product-item men">
							<div class="product discount product_filter">
								<div class="product_image">
									...
									<?php 
										$get_image = $item->selectMainImage($id);

										if($get_image) {
									?>

										<img src="../<?php echo $get_image['image_path'] . $get_image['image_name'];?>" alt="">
								...
								<div class="product_info">
									<h6 class="product_name"><a href="single.php?item_id=<?php echo $row['item_id'];?>"><?php echo $row['item_name'];?></a></h6>
									<div class="product_price">$<?php echo $row['item_price'];?>.00</div>
								</div>
							</div>
						</div>
						<?php
